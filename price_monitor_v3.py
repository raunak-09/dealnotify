"""
Price Drop Alert Bot - Version 3 with Email Integration
"""
...
from email_alerts import send_price_drop_email
...
def check_all_prices():
    ...
    for product in db["products"]:
        ...
        # Check if below target and send email
        if current_price <= product['target_price']:
            print(f"   🎉 ALERT! Price is at or below target!")
            ...
            # SEND EMAIL ALERT
            print(f"   📧 Sending email to {product['email']}...")
            send_price_drop_email(alert)
...
if __name__ == "__main__":
    print("Price Monitor v3 - Ready to send emails!")
